...
Build and UI verification details are recorded in [docs/VALIDATION.md](docs/VALIDATION.md). After packaging, `python3 tests/package-smoke.py` verifies the Debian archive without installing it. A real native preview is available in [assets/cleanly-preview.png](assets/cleanly-preview.png).
